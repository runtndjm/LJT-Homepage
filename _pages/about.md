...
1. **Junteng Liu**, Yuanxiang Fan, Zhuo Jiang, Han Ding, Yongyi Hu, Chi Zhang, Yiqi Shi, Shitong Weng, Aili Chen, Shiqi Chen, Yunan Huang, Mozhi Zhang, Pengyu Zhao, Junjie Yan, Junxian He. **SynLogic: Synthesizing Verifiable Reasoning Data at Scale for Learning Logical Reasoning and Beyond.** *ArXiv*, 2025. Junteng Liu is first author; a GitHub code repository is available.

2. **Junteng Liu**, Weihao Zeng, Xiwen Zhang, Yijun Wang, Zifei Shan, Junxian He. **On the Perception Bottleneck of VLMs for Chart Understanding.** *ArXiv*, 2025. Junteng Liu is first author; GitHub code repository: Vision4Chart.

### 2024

3. **Junteng Liu**, Shiqi Chen, Yu Cheng, Junxian He. **On the Universal Truthfulness Hyperplane Inside LLMs.** *EMNLP 2024*. Junteng Liu is first author; GitHub code repository: Universal_Truthfulness_Hyperplane.
...
For inquiries, please contact **Junteng Liu** by email at [jliugi@connect.ust.hk](mailto:jliugi@connect.ust.hk).
